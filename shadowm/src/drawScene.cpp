...
void drawModel(const Model &model, const glm::mat4 &m, int pass) {
	...
	/// gl::lookAt, con la posicion de la luz mirando al centro de escena	
	...
	/// NOTA IMPORTANTE:
	/// LA COMBINACION DE ESTOS 2 (LOOKAT + lightProjection)
	/// da una matriz de transformacion que transforma CADA vector del espacio-mundo
	/// en el espacio de la luz. (Lo que se necesita para representar el mapa de profundidad)
	// Esa combinacion (producto) esta en shadow_map.vert
